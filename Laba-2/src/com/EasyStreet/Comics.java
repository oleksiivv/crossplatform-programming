...
public class Comics extends Book{
    ...
    public Comics(String name, int pagesCount, BookGenre genre, BookCategory category){
        this.name = name;
    ...
    public static LibraryProductItem readFromFile(Scanner fread){
        if(fread.hasNextLine()) {
            ...
            return new Comics(name, pagesCount, genre, category);
        }
        return null;
    }
